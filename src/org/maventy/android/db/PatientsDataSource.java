...
public class PatientsDataSource {
	...
	values.put(MySQLiteHelper.COLUMN_LASTNAME, " ");
	...
	try {
	    Cursor cursor = database.query(MySQLiteHelper.TABLE_PATIENTS,
		    ...
		    MySQLiteHelper.COLUMN_NAME + "=? and " + MySQLiteHelper.COLUMN_DATEOFBIRTH + "=? and " + MySQLiteHelper.COLUMN_SEX + "=? and " + MySQLiteHelper.COLUMN_RESIDENCE + "=?", new String[] {name, lastName, birthDate, sex, residence}, null, null, null, null);
