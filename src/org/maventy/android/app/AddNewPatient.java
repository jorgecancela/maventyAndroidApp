...
public class AddNewPatient extends Activity implements Runnable {  
    ...
    private EditText etName, etCaregiver;  // etLastName;
	...
	try {
	    ...
	    Tools.setActivity(AddNewPatient.this);
	...
	if (Name.equals(null) || Name.equals("") 
	    ...
	    Patient myPatient = pSource.searchPatient(Name, "", Tools.CalendarToString(dateOfBirth), sex.toString(), Residence);
	...
	protected void onPostExecute(ArrayList<String> result) {
		...
		// WARNING! Do  not lauch toast message within an AsyncTask
		Log.e("AddNewPatient", "Exception within LoadMadagascarLocation AsyncTask " + e.toString());
	    }
	}
    }
}
